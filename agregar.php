...
function formulario_agregar_dispositivo() {
  echo '
  <div class="container mt-4">
  <form method="POST" action="">
  <input type="hidden" name="formulario" value="formulario_agregar">
  <div class="row">
       <form method="POST" action="">
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['formulario'])) {
        ...
        if ($formulario === 'formulario_agregar') {
            ...
            $resultadoAgregar = agregarDispositivo($proyecto, $nombre, $tipo, $direccion_mac, $direccion_ip, $protocolo_acceso, $ubicacion, $informacion_adicional);
        
            if ($resultadoAgregar) {
                mostrarAlerta('success', 'Dispositivo agregado correctamente');
                // Redirige al usuario después de procesar el formulario
            } else {
                mostrarAlerta('danger', 'Error al agregar el dispositivo');
            }
