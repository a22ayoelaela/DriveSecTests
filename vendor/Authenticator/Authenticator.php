...
class Authenticator
{
    ...
    /* Funcion anterior para generar imagen QR con el servicio de google CAIDO.
    ...
    */
    ...
    public function getQR($name, $secret, $title = null, $params = array())
    {
        ...
        // Construir la URL del servicio de goQR.me
        $apiUrl = "https://api.qrserver.com/v1/create-qr-code/";
        $url = "{$apiUrl}?data={$urlencoded}&size={$width}x{$height}&format=png&level={$level}";
